  ...
  >
    <template v-slot:top>
      <v-toolbar flat>
        ...
        <v-spacer></v-spacer>
         <v-text-field class="text-xs-center" v-model="search" append-icon="mdi-magnify" label="Busqueda" single-line hide-details></v-text-field>
        <v-spacer></v-spacer>
            ...
            <v-card-text>
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field
                      v-model="editedItem.documentoDeIdentidad"
                  ...
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field
                      v-model="editedItem.categoria_personal"
