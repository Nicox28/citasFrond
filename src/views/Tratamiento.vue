          ...
          <v-dialog v-model="dialogDelete" max-width="500px">
            <v-card>
              <v-card-title class="text-h7"
                >Estas seguro de borrar este Tratamiento?</v-card-title
              >
              <v-card-actions>
                <v-spacer></v-spacer>
...
export default {
  ...
  computed: {
    formTitle() {
      return this.editedIndex === -1 ? "Nuevo Tratamiento" : "EDITAR TRATAMIENTO";
    },
  },
          ...
          axios
            .patch(
              RUTA_SERVIDOR +
                ...
                "/",
              {
                num_trata: this.editedItem.num_trata,
                nomb_trata: this.editedItem.nomb_trata,
              },
              {
                headers: { Authorization: this.auth },
              }
